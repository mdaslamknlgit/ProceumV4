...
namespace Proceum
{
    public partial class MainVideo : Form
    {
        #region Variables
        ...
        private void MainVideo_Load(object sender, EventArgs e)
        {
        ...
        private void MainVideo_FormClosing(object sender, FormClosingEventArgs e)
        {
            webView21.Dispose();
