...
namespace Proceum.Customer_cloud.Controls
{
    public partial class PoperContainer : ToolStripDropDown
    {
        ...
        private void Show(Control control, Rectangle area)
        {
            ...
            Point location = control.PointToScreen(new Point(area.Left, area.Top));

            Rectangle screen = Screen.FromControl(control).WorkingArea;

            location.X = location.X + Size.Width > screen.Right ? screen.Right - Size.Width : location.X;
            location.Y = location.Y + Size.Height < screen.Top ? screen.Top + control.Height + Size.Height : location.Y;
